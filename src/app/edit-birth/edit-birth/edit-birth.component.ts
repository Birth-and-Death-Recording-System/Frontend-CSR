...
export class EditBirthComponent implements OnInit{
  ...
  constructor(private http: HttpClient, private fb: FormBuilder, private activate: ActivatedRoute, private birthService: BirthService, 
  ...
  updateBirthData() {
    this.birthService.updateBirthDeatils(this.birthForm.value, this.birthid).subscribe({
      next:(data: any) => {
          console.log(data)
